...
const renderTransactions = () => {
    ...
    let netAmountEl = document.getElementById("netAmount");
    let earningEl = document.getElementById("earning");
    ...
    transactions.forEach((transaction) => {
        ...
        <div class="status credit ${isCredit ? "credit" : "debit"} "> ${isCredit ? "C" : "D"}</div>
        </div>
        <div class="lower">
